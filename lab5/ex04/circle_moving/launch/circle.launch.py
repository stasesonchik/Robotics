...
def generate_launch_description():
    ...
    pkg_project_description = get_package_share_directory('my_first_robot')
    pkg_ros_gz_sim = get_package_share_directory('ros_gz_sim')

    urdf_path = os.path.join(pkg_project_description, 'src', 'description', 'robot.urdf.xacro')
